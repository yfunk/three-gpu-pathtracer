...
`}),h("27Lyk").register(new URL("",import.meta.url).toString(),JSON.parse('["ekW0C","areaLight.aaa9b5da.js","lWWke","generateMeshBVH.worker.373f3c58.js","9P1cE","generateMeshBVH.worker.cd4b9fc6.js","512E4","parallelMeshBVH.worker.22cf4bb0.js","9P1cE","generateMeshBVH.worker.cd4b9fc6.js","jwbL2","aoRender.e5303912.js","63CMm","aoRender.a1271ff5.js","2tzBs","aoRender.89c1b67b.js","6UuCC","aoRender.5fc59dbe.js","6mMEU","aoRender.fc8349f1.js","i0zVc","aoRender.dcf40b33.js","j19h5","aoRender.e8b1599c.js","eif6c","areaLight.5654e8b2.js"]'));var p=h("ilwiq"),m=h("5Rd1x"),p=h("ilwiq");class f extends p.RectAreaLight{constructor(...e){super(...e),this.isCircular=!1}copy(e,t){return super.copy(e,t),this.isCircular=e.isCircular,this}}var g=h("8mHfG"),v=h("891vQ"),x=h("jiuw3"),b=h("7lx9d"),y=h("kp7Te"),w=h("kqOCM"),T=h("cE5k3"),C=h("e2Pv4");const k={enabled:!0,isCircular:!1,intensity:2,color:"#ffffff",width:1,height:1,bounces:5,renderScale:1/window.devicePixelRatio,filterGlossyFactor:.5,tiles:1,multipleImportanceSampling:!0,...(0,T.getScaledSettings)()};function S(){a.isCircular=k.isCircular,a.intensity=k.intensity,a.width=k.width,a.height=k.height,a.color.set(k.color).convertSRGBToLinear(),a.visible=k.enabled,e.filterGlossyFactor=k.filterGlossyFactor,e.bounces=k.bounces,e.renderScale=k.renderScale,e.multipleImportanceSampling=k.multipleImportanceSampling,e.updateLights()}function _(){t.setSize(window.innerWidth,window.innerHeight),t.setPixelRatio(window.devicePixelRatio),o.aspect=window.innerWidth/window.innerHeight,o.updateProjectionMatrix(),e.updateCamera()}!async function(){(n=new C.LoaderElement).attach(document.body),(t=new p.WebGLRenderer({antialias:!0})).toneMapping=p.ACESFilmicToneMapping,document.body.appendChild(t.domElement),(e=new g.WebGLPathTracer(t)).tiles.set(k.tiles,k.tiles),e.setBVHWorker(new w.ParallelMeshBVHWorker),(o=new p.PerspectiveCamera(75,window.innerWidth/window.innerHeight,.025,500)).position.set(0,.6,2.65),(r=new m.OrbitControls(o,t.domElement)).target.set(0,.33,-.08),r.addEventListener("change",()=>e.updateCamera()),r.update(),(i=new p.Scene).environmentIntensity=.03,i.backgroundIntensity=.03;let[s,l]=await Promise.all([new(0,v.RGBELoader)().loadAsync("https://raw.githubusercontent.com/gkjohnson/3d-demo-data/master/hdri/leadenhall_market_1k.hdr"),new(0,b.GLTFLoader)().setMeshoptDecoder(y.MeshoptDecoder).loadAsync("https://raw.githubusercontent.com/gkjohnson/3d-demo-data/main/models/mercury-about-to-kill-argos/scene.glb")]);s.mapping=p.EquirectangularReflectionMapping,i.background=s,i.environment=s;let c=new p.Box3;l.scene.traverse(e=>{e.material&&(e.material.map=null)}),l.scene.scale.setScalar(.01),l.scene.position.x=.05,l.scene.updateMatrixWorld(!0),c.setFromObject(l.scene),l.scene.position.y-=c.min.y,i.add(l.scene);let d=new p.CylinderGeometry(3.5,3.5,.05,60),h=new p.MeshStandardMaterial({color:new p.Color(10066329),metalness:.2,roughness:.02}),u=new p.Mesh(d,h);u.position.y=-.025,i.add(u),(a=new f(new p.Color(16777215),5,1,1)).position.x=1.5,a.position.y=1,a.position.z=-.5,a.rotateZ(-Math.PI/4),a.rotateX(-Math.PI/2),a.isCircular=!1,i.add(a);let T=new f(new p.Color(16711680),15,1.25,2.75);T.position.y=1.25,T.position.z=-1.5,T.rotateX(Math.PI),T.isCircular=!1,i.add(T),await e.setSceneAsync(i,o,{onProgress:e=>{n.setPercentage(e)}}),n.setCredits("Model courtesy of Virtual Museums of Małopolska");let P=new x.GUI,B=P.addFolder("Path Tracer");B.add(k,"tiles",1,4,1).onChange(t=>{e.tiles.set(t,t)}),B.add(k,"filterGlossyFactor",0,1).onChange(S),B.add(k,"bounces",1,15,1).onChange(S),B.add(k,"renderScale",.1,1).onChange(S),B.add(k,"multipleImportanceSampling").onChange(S),B.close();let M=P.addFolder("Area Light");M.add(k,"enabled").name("enable").onChange(S),M.add(k,"isCircular").name("isCircular").onChange(S),M.add(k,"intensity",0,200).name("intensity").onChange(S),M.addColor(k,"color").name("color").onChange(S),M.add(k,"width",0,5).name("width").onChange(S),M.add(k,"height",0,5).name("height").onChange(S),S(),_(),window.addEventListener("resize",_),function t(){requestAnimationFrame(t),e.renderSample(),n.setSamples(e.samples)}()}();
